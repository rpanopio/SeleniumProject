...
public class Payment {
  ...
  public void f() {
	  System.setProperty("webdriver.chrome.driver", "/Users/ronelpanopio/Downloads/chromedriver-mac-arm64/chromedriver");
		...
		object.findElement(By.xpath("//*[@id=\"learn-press-payment\"]/ul/li/label")).click();
		
		object.findElement(By.name("learn_press_checkout_place_order")).click();
		
		object.findElement(By.className("InputContainer")).sendKeys("4242 4242 4242 4242");
  }
}
